...
{
  $data = $_GET['search'];
  $consultar = "select * from usuarios where id like'%$data%' or nome like '%$data%'";
}else{
...
//         $conexao = mysqli_query($conn, $sql);
        ...
        while ($registros = mysqli_fetch_array($result)) {
            ...
            echo "<td>" . $registros['nome2'] . "</td>";
            echo "<td>" . $registros['email'] . "</td>";
            echo "<td>" . $registros['telefone'] . "</td>";
            echo "<td>" . $registros['cpf'] . "</td>";
            echo "<td>" . $registros['sen'] . "</td>";
            echo "<td>" . $registros['cep'] . "</td>";
            echo "<td>" . $registros['rua'] . "</td>";
    ...
    <a class='btn btn-primary btn-black' href='update.php?id=$registros[id]'>
  ...
  <path fill-rule='evenodd' d='M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z'/>
    ...
    <a class='btn btn-danger btn-sm' href='deletar.php?id=$registros[id]'>
